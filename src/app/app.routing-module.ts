...
export const routes: Routes = [
  ...
  {
    path: 'terms-and-conditions/:lingua',
    component: TermsAndConditionsComponent
  },
  { 
    path: 'activate/enter-code/:user_id', 
    component: ActivationEnterCodeComponent 
  },
  { 
    path: 'activate/:token/:user_id', 
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'chat',
        loadChildren: () => import('./back-office/views/conversation/conversation.module').then(m => m.ConversationModule)
      },
      {
        path: 'chat/:id',
        loadChildren: () => import('./back-office/views/chat/chat.module').then(m => m.ChatModule)
      ...
      {
        path: 'notifications',
        loadChildren: () => import('./back-office/views/notification/notification.module').then(m => m.NotificationModule)
      },
      {
        path: 'mykarryngo',
      ...
      {
        path: 'my-services',
        loadChildren: () => import('./back-office/views/my-services/my-services.module').then(m => m.MyServicesModule)
      },
      {
