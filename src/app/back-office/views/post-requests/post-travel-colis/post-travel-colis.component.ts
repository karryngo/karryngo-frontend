...
@Component({
  selector: 'app-post-travel-colis',
  templateUrl: './post-travel-colis.component.html',
  styleUrls: ['./post-travel-colis.component.scss']
})
@Injectable()
export class PostTravelColisComponent implements OnInit {

  title = 'New Parces travel ';
