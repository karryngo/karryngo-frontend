...
@Component({
  selector: 'app-post-request-rent',
  templateUrl: './post-request-rent.component.html',
  styleUrls: ['./post-request-rent.component.scss']
})
export class PostRequestRentComponent implements OnInit {
  ...
  initPage() {
    if (this.interface1) {
      this.titleInterface = this.title;
      this.visible = true;
